...
func (d *Daemon) Start(ctx context.Context) error {
	...
	if d.cfg.Daemon.Listen != "" {
		d.logger.Warn("daemon.listen is configured but tcp control plane is not implemented", "listen", d.cfg.Daemon.Listen)
		d.resetStartState(cancel)
		return errors.New("daemon.listen is not supported yet")
	}
